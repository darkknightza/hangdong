<?php
    ...
    $sql="SELECT * FROM `news_information` WHERE NEWS_ID = $ID";
...
<body>
    ...
    <a href="index.html" class="logo"><img src="images/logo.gif" alt="" style="height: 100px;width: 100px" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h1>&nbsp;&nbsp;&nbsp;เทศบาลตำบลหางดง</h1>
        ...
        <div class="container">
                    ...
                    <form method="post" class="hpform" action="save-Editnews.php" enctype="multipart/form-data">
                        <input type="hidden" name="NewsId" value="<?php echo $objResult['NEWS_ID'] ?>">
                        <input type="text" name="txtName" placeholder="หัวข้อข่าว" value="<?php echo $objResult['NEWS_NAME'] ?>" />
                        <input type="text" name="txtLink" placeholder="ลิ๊งค์เว็ปไซด์" value="<?php echo $objResult['NEWS_LINK'] ?>"/>
                        
                        <textarea placeholder="รายละเอียดข่าว" name="txtMsg"><?php echo $objResult['NEWS_DETAILS'] ?></textarea>
                        <input type="hidden" name="NEWSPICTURE" value="<?php echo $objResult['NEWS_PICTURE'] ?>">
                        <input type="hidden" name="NEWSFILE" value="<?php echo $objResult['NEWS_FILE'] ?>">
